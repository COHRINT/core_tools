...
from cohrint_core.map_tools.map_elements import MapObject, MapArea
from cohrint_core.map_tools.shape_layer import ShapeLayer
from cohrint_core.map_tools.feasible_layer import FeasibleLayer
from cohrint_core.map_tools.probability_layer import ProbabilityLayer
from cohrint_core.map_tools.particle_layer import ParticleLayer
from cohrint_core.map_tools.human_interface import HumanInterface
...
class Map(object):
    ...
    def __init__(self, map_name='fleming', bounds=[-5, -5, 5, 5],
        ...
        path = '/home/matt/catkin_ws/src/cops_and_robots_ros' + \
               '/src/cops_and_robots/config_python.yaml'
        self.human_cfg = load_config(path=path)['human_interface']
